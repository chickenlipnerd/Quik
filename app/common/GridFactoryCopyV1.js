Ext.define('QS.common.GridFactory', {
    ...
    createGridReport: function (isPreview, name, params, columnInfo, rType, menu) {
        ...
        for (; i < c; i++) {
            ...
            if (columns[i].hideRepeats) {

                var helper = helperMethods[columns[i].renderer];
                
                sRenderer = function (value, metaData, record, rowIndex, colIndex, store, view, dataIndex, helper) {
                    
                    
                    
                    return helperMethods.hideRepeats(value, rowIndex, dataIndex, helper);
                };
                
                columns[i].renderMeta = 'hideRepeats';
            } else {
